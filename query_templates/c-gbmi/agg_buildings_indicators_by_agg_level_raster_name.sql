DROP TABLE IF EXISTS {{gbmi_schema}}.agg_buildings_indicators_by_{{agg_level}}_{{raster_name}};

CREATE TABLE {{gbmi_schema}}.agg_buildings_indicators_by_{{agg_level}}_{{raster_name}} AS (
                                                                        WITH agg0 AS (
                                                                                     SELECT
                                                                                         {{agg_columns}},
                                                                                         {{agg_geom}},
