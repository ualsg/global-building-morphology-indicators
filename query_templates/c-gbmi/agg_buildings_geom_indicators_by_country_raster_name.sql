...
CREATE TABLE {{gbmi_schema}}.agg_buildings_geom_indicators_by_country_{{raster_name}} AS (
                                                                     WITH agg1 AS (
                                                                                  SELECT
                                                                                      ...
                                                                                      count(DISTINCT osm_id) / ccwa.gadm_area_sqm AS buildings_count_normalised,
                                                                                      ...
                                                                                      sum(clipped_bldg_area) / ccwa.gadm_area_sqm AS footprint_area_sum_normalised,
                                                                                      ...
                                                                                      sum(clipped_bldg_perimeter) / ccwa.gadm_area_sqm AS perimeter_sum_normalised,
                                                                                      ...
                                                                                      sum(est_volume) / ccwa.gadm_area_sqm AS volume_sum_normalised,
                                                                                      ...
                                                                                      sum(est_wall_area) / ccwa.gadm_area_sqm AS wall_area_sum_normalised,
                                                                                      ...
                                                                                      sum(est_envelope_area) / ccwa.gadm_area_sqm AS envelope_area_sum_normalised,
                                                                                      ...
                                                                                      sum(vertices_count) / ccwa.gadm_area_sqm AS vertices_count_sum_normalised,
                                                                                      ...
                                                                                      sum(est_floor_area) / ccwa.gadm_area_sqm AS floor_area_sum_normalised,
                                                                                      stddev_pop(est_floor_area) AS floor_area_sd,
                                                                                      count(is_residential) FILTER ( WHERE is_residential IS TRUE ) AS residential_count,
                                                                                      count(is_residential) / ccwa.gadm_area_sqm AS residential_count_normalised,
                                                                                      ...
                                                                                      sum(est_floor_area) FILTER ( WHERE is_residential IS TRUE ) / ccwa.gadm_area_sqm AS residential_floor_area_sum_normalised,
